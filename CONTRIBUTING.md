...
```bash
git clone https://github.com/ArcavenAE/tmux-cmc.git
cd tmux-cmc
just build    # Build
just test     # Run tests
...
Open a [Bug Report](https://github.com/ArcavenAE/tmux-cmc/issues/new?template=bug-report.yml) and include:
...
Open a [Feature Request](https://github.com/ArcavenAE/tmux-cmc/issues/new?template=feature-request.yml).
